...
class TstPlan(TestPlans):
    ...
    def set_test_unit(self, test_unit='', **kwargs):
        ...
        testunitAdded = self.base_selenium.select_item_from_drop_down(element='test_plan:test_units', item_text=test_unit)
        if testunitAdded == False:
            return testunitAdded
