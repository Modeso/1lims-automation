elements = {
    'general': {
        ...
        'drop_down_div': {'method': 'class_name',
                          ...
                          'order': 0},
        'drop_down_tu': {'method': 'class_name',
                         'value': 'ng-dropdown-panel-items scroll-host'},
    ...
    'test_plan': {
        ...
        'ok': {'method': 'class_name',
               'value': 'swal2-confirm btn btn-success m-btn m-btn--custom',
               'order': 0},
        'remove_testunit': {'method': 'id',
                            'value': 'remove_testunit'},
        'testunits_name': {'method': 'xpath',
                           'value': '//ng-select[@id="selectedTestUnitsfield"]//input'}
    },
