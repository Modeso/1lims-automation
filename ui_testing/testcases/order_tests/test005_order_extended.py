...
class OrdersExtendedTestCases(BaseTest):
    ...
    @attr(series=True)
    def test005_enter_long_method_should_be_in_multiple_lines_in_order_form(self):
        """
    ...
    def test006_search_with_test_unit_name_method(self, search_by):
        """
    ...
    @attr(series=True)
    def test007_test_unit_with_sub_and_super_unit_name_appears_in_unit_field_drop_down(self, type):
        """
    ...
    @attr(series=True)
    def test008_filter_testunit_by_scripts(self, value):
        """
    ...
    @attr(series=True)
    def test009_change_contact_config(self, search_by):
        '''
    ...
    @attr(series=True)
    def test010_test_unit_name_allow_user_to_filter_with_selected_two_options_order(self, search_view_option1,
                                                                                    search_view_option2):
        """
