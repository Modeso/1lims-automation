...
class TestPlansTestCases(BaseTest):
    ...
    def test001_test_plans_overview_link(self):
        ...
        current_page_name_from_create = self.test_plan.get_current_page_name() # get current page name
        ...
        current_page_name_from_edit = self.test_plan.get_current_page_name() # get current page name

        # check if redirect to the right page
        self.test_plan.info('Overview visited from test plan edit')
        self.assertEqual(current_page_name_from_create, 'testPlans')
        self.test_plan.info('Overview visited from test plan create')
        self.assertEqual(current_page_name_from_edit, 'testPlans')
        return