...
#                 self.assertIn(item, fixed_sheet_row_data)
#
    def test069_create_order_then_overview(self):
        """
        ...
        """
        active_table_url=self.orders_page.orders_url
        self.order_page.click_create_order_button()
        self.order_page.sleep_tiny()
        self.order_page.click_overview()
        self.info('Asserting correct redirection to orders active table ')
        self.info('Active table url is {} , current url is {}'.format(active_table_url, self.base_selenium.get_url()))
        self.assertEqual(active_table_url, self.base_selenium.get_url())
