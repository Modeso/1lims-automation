...
class OrdersTestCases(BaseTest):
    ...
    def test106_configure_any_field_in_active_table(self):
        ...
        self.base_pages.set_specific_configure_table_column_to_specific_value(fields=['Contact Name','Order No.'],value=False)
        self.base_selenium.refresh()
        ...
        self.base_pages.set_specific_configure_table_column_to_specific_value(fields=['Contact Name','Order No.'],value=True)
        self.base_selenium.refresh()
        ...
        self.base_pages.set_specific_configure_table_column_to_specific_value(fields=['Created On'],value=False)
        self.base_selenium.refresh()
