...
class TestUnitsTestCases(BaseTest):
    ...
    def test024_create_approach_overview_button(self, ok):
        ...
        self.base_selenium.click(element='test_units:overview')
        self.test_unit_page.sleep_tiny()
        # switch to the alert
        if 'ok' == ok:
            self.base_selenium.click(element='test_units:confirm_overview')
            self.test_unit_page.sleep_tiny()
            ...
            self.base_selenium.click(element='test_units:cancel_overview')
            self.test_unit_page.sleep_tiny()
